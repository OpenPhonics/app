...
interface PhoneticLessonDataSource {
    ...
    suspend fun lessonsChangeList(updatedAfter: Long? = null): List<ChangeListNetwork>
...
interface WordDataSource {
    ...
    suspend fun wordsChangeList(updatedAfter: Long? = null): List<ChangeListNetwork>
...
interface SentenceDataSource {
    ...
    suspend fun sentencesChangeList(updatedAfter: Long? = null): List<ChangeListNetwork>
}